        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" id="iconGrid" style="max-height: 300px; overflow-y: auto;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="confirmIconSelection" disabled>Select Icon</button>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    // Inject icons into the grid
    const $grid = $('#iconGrid');
    icons.forEach(icon => {
        $grid.append(`
            <div class="col-1">
                <button type="button" class="btn btn-outline-secondary icon-option w-100 p-2 mb-1" data-icon="${icon}" title="${icon}" style="aspect-ratio: 1; font-size: 14px;">
                    <i class="${icon}"></i>
                </button>
            </div>
        `);
    ...
    $(document).on('click', '.icon-option', function () {
        ...
        $('#confirmIconSelection').prop('disabled', false).text(`Select "${selectedIcon}"`);
    });

    // Confirm selection
    $('#confirmIconSelection').click(function () {
        if (selectedIcon) {
            $('#icon-picker').html(`<i class="${selectedIcon} me-2"></i> <span class="selected-icon-text">${selectedIcon}</span>`);
    ...
    $('#iconSearch').on('input', function () {
        ...
        $('.icon-option').each(function () {
            ...
            const $col = $(this).closest('.col-1');
            $col.toggle(icon.includes(term));
        });
    });
    ...
    $('#iconPickerModal').on('hidden.bs.modal', function () {
        ...
        $('.icon-option').removeClass('selected');
        selectedIcon = '';
        $('#confirmIconSelection').prop('disabled', true).text('Select Icon');
    });
});
</script>
