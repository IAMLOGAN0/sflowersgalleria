    ...
    <div class="container">
        <div class="tf-grid-layout md-col-2 tf-img-with-text img-text-3 img-text-3-style-2">
            ...
            <div class="tf-image wow fadeInUp" data-wow-delay="0s">
                <div class="grid-img-group">
                    ...
                    <div class="box-img item-1 hover-img tf-image-wrap">
                        <div class="img-style">
                            <img class="lazyload"
                                 data-src="{{ asset('frontend_v1/images/collections/img-w-text-grocery1.jpg') }}"
                                 src="{{ asset('frontend_v1/images/collections/img-w-text-grocery1.jpg') }}"
                                 alt="img-slider">
                        </div>
                    </div>
                    ...
                    <div class="box-img item-2 hover-img tf-image-wrap">
                        <div class="img-style">
                            <img class="lazyload"
                                 data-src="{{ asset('frontend_v1/images/collections/img-w-text-grocery2.jpg') }}"
                                 src="{{ asset('frontend_v1/images/collections/img-w-text-grocery2.jpg') }}"
                                 alt="img-slider">
                        </div>
                    </div>
                    ...
                    <div class="box-img item-3 hover-img tf-image-wrap">
                        <div class="img-style">
                            <img class="lazyload"
                                 data-src="{{ asset('frontend_v1/images/collections/img-w-text-grocery3.jpg') }}"
                                 src="{{ asset('frontend_v1/images/collections/img-w-text-grocery3.jpg') }}"
                                 alt="img-slider">
                        </div>
                    </div>
            ...
            <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                ...
                <p class="desc fade-item fade-item-2">
                    Delivered every month! Perfect for your favorite vegan or anyone you want <br>
                    to introduce to the best better-for-you foods out there.
                </p>
                <a href="shop-default.html"
                   class="tf-btn btn-fill animate-hover-btn btn-icon radius-60">
